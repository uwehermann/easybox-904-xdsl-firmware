...
extern rtk_api_ret_t rtk_port_phyTestModeAll_set(rtk_port_t port, rtk_port_phy_test_mode_t mode);
extern rtk_api_ret_t rtk_port_phyTestModeAll_get(rtk_port_t port, rtk_port_phy_test_mode_t *pMode);
