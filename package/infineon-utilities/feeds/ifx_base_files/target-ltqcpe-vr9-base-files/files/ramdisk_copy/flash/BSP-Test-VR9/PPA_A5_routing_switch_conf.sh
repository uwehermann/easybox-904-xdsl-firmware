...
# - 20: VLAN ID
# - 1: FID
switch_utility VLAN_IdCreate 20 1
...
#DSL WAN Port VLAN configuration
# - 10: Port ID
# - 20: 2nd DSL WAN Port VID
# - 0: VLAN Unknow Drop disabled
# - 0: VLAN ReAssign disabled
# - 3: Violation Mode Both
# - 0: Admit All
# - 1: TVM enabled
switch_utility VLAN_PortCfgSet 10 20 0 0 3 0 1
...
# - argument: Port ID
# - 0: Tag base Number Egress disabled
for argument in 6 10;do
   switch_utility VLAN_PortMemberAdd 20 $argument 0
done
