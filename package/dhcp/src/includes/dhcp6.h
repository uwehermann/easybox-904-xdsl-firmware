...
// kevin_cheng , 20130116
#define PREFERRED_MODE 0
#define RANDOM_MODE 1
#define ON_DHCP_RENEW 1
...
/* VSIO sub-options */
#define VSIO_TFTP_SERVERS			32
#define VSIO_CONFIG_FILE_NAME			33
#define VSIO_SYSLOG_SERVERS			34
#define VSIO_CCCV6				2171

/* CCCv6 sub-options */
#define CCCV6_DHCP_SERVER_SELECTOR_ID_1		1
#define CCCV6_DHCP_SERVER_SELECTOR_ID_2		2
#define CCCV6_PROVISION_SERVER			3
#define CCCV6_AS_BACKOFF_RETRY			4
#define CCCV6_AP_BACKOFF_RETRY			5
#define CCCV6_KERBEROS_REALM			6
#define CCCV6_TGS_USAGE				7
#define CCCV6_PROVISION_TIMER			8
#define CCCV6_SECURITY_TICKET_INVALIDATION	9
