...
UINT m_ButtonBgNormal;
UINT m_ButtonBgFocus;
UINT m_ButtonBgPressed;
COLORREF m_ButtonTextColorNormal;
COLORREF m_ButtonTextColorFocus;
COLORREF m_ButtonTextColorpressed;
