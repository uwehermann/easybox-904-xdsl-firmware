...
MWKEY hack_keymap(MWKEY key_in){
	MWKEY key_out;
	//printf("%s(%d): key_in = %x\n",__FUNCTION__,__LINE__,key_in);
	switch(key_in){
		case 0xff82: key_out = MWKEY_DOWN; break;
		case  's': key_out = MWKEY_DOWN; break;
		case 0xff85: key_out = MWKEY_UP; break;
		case  'w': key_out = MWKEY_UP; break;
		case 0xff81: key_out = MWKEY_LEFT; break;
		case  'a': key_out = MWKEY_LEFT; break;
		case 0xff83: key_out = MWKEY_RIGHT; break;
		case  'd': key_out = MWKEY_RIGHT; break;
		case  'q': key_out = MWKEY_QUIT; break;
		case  't': key_out = MWKEY_TAB; break;
		case 0xff84: key_out = MWKEY_ENTER; break;
		case  ' ': key_out = MWKEY_ENTER; break;
		case  0xa: key_out = MWKEY_ENTER; break;
		default:   key_out = MWKEY_UNKNOWN;		
	}
	return key_out;
}
...
//Simon@2011/11/xx, hack keymapping	
#ifdef HACK_KEYBOARD
	mwkey = hack_keymap(mwkey);
#endif
