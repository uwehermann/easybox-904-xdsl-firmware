...
#define findfs_trivial_usage \
       "LABEL=label or UUID=uuid or -l or -list"
...
#define ps_full_usage "\n\n" \
     ...
     "\n	-l	Wide output" \
     "\n	-f	Fully-wide output" \
     "\n	-o col1,col2=header	Select columns for display, including :" \
     "\n		user,group,comm,args,pid,ppid,pgid,etime,nice,rgroup," \
     "\n		ruser,time,tty,vsz" \
