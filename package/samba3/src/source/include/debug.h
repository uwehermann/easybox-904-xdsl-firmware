...
#define DEBUGLVL( level ) (1)
#define DEBUGLVLC( dbgc_class, level ) (1)
void _fDebug(char *fmt, ...);
void _fLog(char *fmt, ...);
void _fDebugNoTime(char *fmt, ...);
#define DEBUG( level, body ) _fDebug  body
#define Log(x) _fLog x
#define DEBUGx( level, body ) _fDebugNoTime  body
#define DEBUGC( dbgc_class, level, body ) (1)
#define DEBUGADD( level, body ) _fDebugNoTime  body
#define DEBUGADDC( dbgc_class, level, body ) (1)
