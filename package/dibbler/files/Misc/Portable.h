...
#define CLNTCONF_FILE      "/var/etc/dibbler/client.conf"
#define SRVCONF_FILE       "/var/etc/dibbler/server.conf"
#define RELCONF_FILE       "/var/etc/dibbler/relay.conf"
#define RESOLVCONF_FILE    "/var/resolv.conf"
#define NTPCONF_FILE       "/var/ntp.conf"
#define RADVD_FILE         "/var/etc/dibbler/radvd.conf"
