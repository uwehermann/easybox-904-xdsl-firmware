...
kernel_change_default: .config FORCE
	$(_SINGLE)$(NO_TRACE_MAKE) -C target/linux change_default

kernel_setup_links: .config FORCE
	@$(_SINGLE)$(NO_TRACE_MAKE) -C target/linux setup-links

kernel_remove_links: .config FORCE
	@$(_SINGLE)$(NO_TRACE_MAKE) -C target/linux remove-links

kernel_redo_links:kernel_remove_links kernel_setup_links
	@echo All kernel links have been setup successfully

# Needs a better implementation for mostlyclean
kernel_mostly_clean:.config FORCE
	@$(_SINGLE)$(NO_TRACE_MAKE) -C target/linux mostlyclean
...
distclean:
	rm -rf tmp build_dir staging_dir dl .config* config feeds package/feeds package/openwrt-packages bin
